function Fireball(origin)
{
	...
	{		
		...
		$this.setAnimation(new SpritesheetAnimation("img/hadouken" + animationSufix, 42, 40));
		
		$this.explodeAnimation = new SpritesheetAnimation("img/power_explode" + animationSufix, 42, 40);
